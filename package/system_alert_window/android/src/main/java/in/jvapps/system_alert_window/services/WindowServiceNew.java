...
public class WindowServiceNew extends Service implements View.OnTouchListener {
    ...
    public void onCreate() {
        ...
        /* FlutterEngine flutterEngine = FlutterEngineCache.getInstance().get(Constants.FLUTTER_CACHE_ENGINE);
        if (flutterEngine != null) {
            overlayMessageChannel = new BasicMessageChannel<>(flutterEngine.getDartExecutor(), Constants.MESSAGE_CHANNEL, JSONMessageCodec.INSTANCE);
        }  */
        FlutterEngine flutterEngine = FlutterEngineCache.getInstance().get(Constants.FLUTTER_CACHE_ENGINE);
        if (flutterEngine == null) {
    ...
    private WindowManager.LayoutParams getLayoutParams() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) { 
            ...
            if (isDisableClicks) {
                params.flags = WindowManager.LayoutParams.FLAG_HARDWARE_ACCELERATED | android.view.WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE | WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED | android.view.WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_TURN_SCREEN_ON | WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD;
            } else {
                params.flags =  WindowManager.LayoutParams.FLAG_HARDWARE_ACCELERATED | android.view.WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL | WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED | android.view.WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_TURN_SCREEN_ON | WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD;
            }
        } else {
            params.type = android.view.WindowManager.LayoutParams.TYPE_SYSTEM_ALERT;
            if (isDisableClicks) {
                params.flags =  WindowManager.LayoutParams.FLAG_HARDWARE_ACCELERATED | android.view.WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE | android.view.WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | android.view.WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED;
            } else {
                params.flags = WindowManager.LayoutParams.FLAG_HARDWARE_ACCELERATED | android.view.WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL | android.view.WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | android.view.WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED;
            }
        }
