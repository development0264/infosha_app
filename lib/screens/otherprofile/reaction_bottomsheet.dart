...
class _CustomSheetState extends State<CustomSheet>
  ...
  List<CommentReactionData> likeList = [];
  List<CommentReactionData> dislikeList = [];
  List<CommentReactionData> loveList = [];
  List<CommentReactionData> hahaList = [];
  List<CommentReactionData> wowList = [];
  List<CommentReactionData> angryList = [];
  List<CommentReactionData> cryList = [];
  List<CommentReactionData> facepalmList = [];

  @override
  void initState() {
    print("id ==> ${widget.commentid}");
    provider = Provider.of<UserViewModel>(context, listen: false);
    Future.microtask(() => context
        .read<UserViewModel>()
        .getReactionOfComment(widget.commentid)).then(
      (value) {
        filterList();
      },
    );
  ...
  filterList() async {
    if (provider.commentReactionModel.data != null) {
      for (var item in provider.commentReactionModel.data!) {
