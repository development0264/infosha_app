...
class ReviewVoteBottomSheet {
  showReviewVote(BuildContext context, String id, bool isLike) async {
...
class ReviewVoteSheet extends StatefulWidget {
  String id;
  bool isLike;
  ReviewVoteSheet({super.key, required this.id, required this.isLike});

  @override
  State<ReviewVoteSheet> createState() => _VoteSheetState();
}

class _VoteSheetState extends State<ReviewVoteSheet> {
  late UserViewModel provider;
  bool isLoading = false;
  late ReviewVoteModel reviewVoteModel;
  ...
  getData() async {
    ...
    reviewVoteModel = await Provider.of<UserViewModel>(context, listen: false)
        .reviewVoteList(widget.id, widget.isLike);
    setState(() {
      isLoading = false;
    });
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  isLoading
                      ...
                      : reviewVoteModel.data != null &&
                              reviewVoteModel.data!.isEmpty
                          ? SizedBox(
                              height: Get.height * 0.4,
                              width: Get.width,
                              child: const Center(
                          ...
                          : Expanded(
                              child: ListView.builder(
                                ...
                                itemCount: reviewVoteModel.data!.length,
                                shrinkWrap: true,
                                itemBuilder: (context, index) {
                                  var data = reviewVoteModel.data![index];
