...
class EditSocialMedialUnregister extends StatefulWidget {
  UnregisteredUserModel viewProfileModel;
  String id;
  EditSocialMedialUnregister(
      {Key? key, required this.viewProfileModel, required this.id})
      : super(key: key);
...
class _EditSocialMedialScreenState extends State<EditSocialMedialUnregister> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 1)).then((value) {
      /* setState(() {
          google.text = widget.viewProfileModel.data!.email!;
          facebook.text = widget.viewProfileModel.data!.facebookId!;
          insta.text = widget.viewProfileModel.data!.instagramId!;
        }); */
    });
  }
              ...
              return CustomButton(
                () {
                  if (_form.currentState!.validate()) {
                    ...
                    // payload
                    //     .addAll({"name": widget.viewProfileModel.data!.name!});
