...
class NicknameUnRegisteredView extends StatefulWidget {
  List<GetNickName> nickName;

  NicknameUnRegisteredView({Key? key, required this.nickName})
      : super(key: key);
...
class _ChangeNameViewState extends State<NicknameUnRegisteredView> {
  late String selectedName;
  List<String> temp1 = [];
  bool isLoaidng = false;

  @override
  void didUpdateWidget(covariant NicknameUnRegisteredView oldWidget) {
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        constraints: BoxConstraints(
                            maxWidth: Get.width * 0.6, minWidth: 0),
                        child: CustomText(
                          text: selectedName,
                          color: whiteColor,
                          fontSize: 16.sp,
