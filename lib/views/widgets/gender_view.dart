...
class GenderView extends StatefulWidget {
  List<GetGender> nickName;

  GenderView({Key? key, required this.nickName}) : super(key: key);
...
class _AddressViewState extends State<GenderView> {
  ...
  @override
  void didUpdateWidget(covariant GenderView oldWidget) {
    if (widget.nickName.isNotEmpty) {
      setState(() {
        isLoaidng = true;
      });
