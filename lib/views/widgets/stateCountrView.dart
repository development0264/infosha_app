...
class StateCountryOtherView extends StatefulWidget {
  List<GetAddress> nickName;

  StateCountryOtherView({Key? key, required this.nickName}) : super(key: key);
...
class _AddressViewState extends State<StateCountryOtherView> {
  ...
  @override
  void didUpdateWidget(covariant StateCountryOtherView oldWidget) {
    if (widget.nickName.isNotEmpty) {
      setState(() {
        isLoaidng = true;
      });
