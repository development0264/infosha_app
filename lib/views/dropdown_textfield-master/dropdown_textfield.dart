...
class _DropDownTextFieldState extends State<DropDownTextField>
  ...
  updateFunction({DropDownTextField? oldWidget}) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _listTileTextStyle =
          (widget.listTextStyle ?? Theme.of(context).textTheme.bodyMedium)!;
      _listTileHeight =
          ...
          child: Consumer<UserViewModel>(builder: (context, provider, child) {
            return SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Container(
                      child: provider.isShowAddProfessionDialg
                          ? InkWell(
                              onTap: () {
                                if (provider.addDropDownText ==
                                    "Add Profession") {
                                  Get.back();
                                  Get.bottomSheet(EditProfessionDialog(),
